...
function Footer() {
  ...
  return (
<div className='sticky z-10 flex  items-end  '>
<div className="w-full h-screen    flex items-center justify-center bg-black">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div className="w-full text-7xl font-bold">
                <h1 className="w-full md:w-2/3 mt-20">How can we help you. get
                    in touch</h1>
            </div>
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                ...
                <div className="w-44 pt-6 md:pt-0">
                    <NavLink className="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact US</NavLink>
                </div>
            </div>
            <div className="flex flex-col">
                <div className="flex mt-24 mb-12 flex-row justify-between">
                    ...
                    <NavLink to='/About' className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About</NavLink>
                    <NavLink to='/Service' className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Services</NavLink>
                    <NavLink to='/why us' className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Why us</NavLink>
                    <NavLink to='/Contact' className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Contact</NavLink>
                ...
                <p className="w-full text-center my-12 text-gray-600">Copyright © 2024 Find Your Room</p>
            </div>
        </div>
    </div>
